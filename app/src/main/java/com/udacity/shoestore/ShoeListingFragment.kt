...
class ShoeListingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view
        _binding = DataBindingUtil.inflate(inflater, R.layout.fragment_shoe_listing,container,false)
        val view = binding.root

        binding.activityShoeModel=activityViewModel
        binding.lifecycleOwner = viewLifecycleOwner

        //Action bar with signout option
        setHasOptionsMenu(true)

        //Brings to add shoe detail screen
        binding.listingFab.setOnClickListener {
            val action =
